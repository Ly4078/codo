  ...
  <div class="playbook mainboss">
    <div class="initform">
      ...
      >
        ...
        <el-form-item label="选择playbook文件" prop="beifen">
          <el-select v-model="ruleForm.beifen" clearable placeholder="请选择playbook文件">
            <el-option label="playbook文件一" value="shanghai"></el-option>
            <el-option label="playbook文件二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
