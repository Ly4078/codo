  ...
  <div class="deploy mainboss">
    <div class="initform">
      <el-form
        ...
        label-width="130px"
      >
        <el-form-item label="选择主机" prop="zhuji">
        ...
        <el-form-item label="选择应用" prop="leixin">
        ...
        <el-form-item label="选择配置文件" prop="beifen">
          <el-select v-model="ruleForm.beifen" clearable placeholder="请选择配置文件">
            <el-option label="配置文件一" value="shanghai"></el-option>
            <el-option label="配置文件二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="选择发布脚本" prop="beifen">
          <el-select v-model="ruleForm.beifen" clearable placeholder="请选择发布脚本">
            <el-option label="发布脚本一" value="shanghai"></el-option>
            <el-option label="发布脚本二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
